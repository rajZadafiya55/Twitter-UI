		...
		<>
			<div className='flex-[4_4_0] border-l border-r border-gray-700 min-h-screen'>
				...
				{notifications?.map((notification) => (
					<div className='border-b border-gray-700 flex justify-between items-center p-4' key={notification._id}>
						...
						<div className='text-red-500 cursor-pointer' onClick={() => handleDelete(notification._id)}>
